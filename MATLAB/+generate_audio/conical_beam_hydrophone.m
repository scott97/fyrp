% TODO research how to model a conical beam - how is the signal attenuated with a change in angle
function [y,t] = conical_beam_hydrophone(data, fs, loc)
